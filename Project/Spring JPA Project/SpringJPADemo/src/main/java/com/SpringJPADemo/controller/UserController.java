...
public class UserController {
	...
	@Autowired
	   ...
	   // fetching user details by using jpql uName
	   @GetMapping("/getbyname/{uName}")
	   public User userByName(@PathVariable String uName) {
		   return us.userByName(uName);
	   }
	   
	   //fetching user detals by using jpql phnNumber
	   @GetMapping("/getbyphn/{phnNumber}")
	   public User userByPhn(@PathVariable long phnNumber) {
		   return us.userByPhn(phnNumber);
	   }
}
